...
function enviar(){
    var idDigitado = document.getElementById("id_prod").innerHTML; // esta pegando o valor que foi digitado no input e mostrando no console
    document.getElementById("recebe_id").value = idDigitado;
     ...
     var precoDigitado = document.getElementById("p_preco").innerHTML; // esta pegando o valor que foi digitado no input e mostrando no console
